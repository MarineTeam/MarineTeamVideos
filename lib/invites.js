...
// sends the usual notification, then appends {email, token} to the list.
// Emails already on the list are left completely alone — no new record, no
// email — so editing the list only ever notifies people who are new.
export async function addInvitees({ videoId, videoTitle, emails, hours, watermark, siteUrl }) {
