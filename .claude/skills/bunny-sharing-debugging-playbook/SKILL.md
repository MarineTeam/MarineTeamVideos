...
| "Who actually watched this / how did they get in?" | `/api/gate-log` | Not a failure — the grant-exchange audit log (added 2026-09-13) answers it. Emails are fingerprinted; match against the share record | S4 |
